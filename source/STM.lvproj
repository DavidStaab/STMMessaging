...
<Project Type="Project" LVVersion="13008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="compatibility" Type="Folder" URL="../vi.lib/NI/STM/compatibility">
			<Property Name="NI.DISK" Type="Bool">true</Property>
		</Item>
		<Item Name="Templates" Type="Folder">
			<Item Name="STM Command Based Client Template.vit" Type="VI" URL="../vi.lib/NI/STM/Templates/STM Command Based Client Template.vit"/>
			<Item Name="STM Command Based Server Template.vit" Type="VI" URL="../vi.lib/NI/STM/Templates/STM Command Based Server Template.vit"/>
		</Item>
		<Item Name="Tests" Type="Folder">
			<Item Name="test library" Type="Folder" URL="../tests/test library">
				<Property Name="NI.DISK" Type="Bool">true</Property>
			</Item>
			<Item Name="Prebuild Test Suite.lvclass" Type="LVClass" URL="../tests/Prebuild Test Suite/Prebuild Test Suite.lvclass"/>
			<Item Name="TCP API Tests.lvclass" Type="LVClass" URL="../tests/TCP API Tests/TCP API Tests.lvclass"/>
		</Item>
		<Item Name="NI STM.lvlib" Type="Library" URL="../vi.lib/NI/STM/NI STM.lvlib"/>
		<Item Name="STM-errors.txt" Type="Document" URL="../project/errors/STM-errors.txt"/>
